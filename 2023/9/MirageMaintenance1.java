 ...
 * Then, calculate the next element in the original array.
    ...
    public static void main(String[] args) {
        ...
        for (ArrayList<Long> original : histories) {
            ...
            for (int i = 1; i < diffArray.size(); i++) {
                ...
                Long thisValue = lastValue(thisArray);
                Long prevValue = lastValue(prevArray);
                Long diff = thisValue + prevValue;
                thisArray.add(diff);
            }

            Long prediction = lastValue(diffArray.get(diffArray.size() - 1));
